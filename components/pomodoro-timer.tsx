...
export default function PomodoroComponent() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-700 dark:bg-gray-900">
      <Card className="w-full max-w-md p-6 bg-gray-400 dark:bg-gray-800 shadow-lg rounded-lg">
        <div className="flex flex-col items-center justify-center gap-6">
          <h1 className="text-4xl font-bold"><b>Pomodoro Timer</b></h1>
          <p><i>A timer for the Pomodoro Technique.</i></p>
          ...
          <div className="flex items-center gap-4">
            <Button variant="outline" size="icon" onClick={() => handleDurationChange("work", false)}>
              <MinusIcon className="h-6 w-6" />
            </Button>
            <Button variant="outline" size="icon" onClick={() => handleDurationChange("work", true)}>
          ...
          <div className="p-2">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="default"><b>What is Pomodoro Technique?</b></Button>
              </AlertDialogTrigger>
              <AlertDialogContent className="w-full max-w-2xl p-4 md:p-6 border border-white rounded-lg">
                <AlertDialogHeader>
                  <AlertDialogTitle className="text-white border border-white p-2 rounded">
                    <strong> ➡️ Explanation of Pomodoro Technique 🔥</strong>
                  </AlertDialogTitle>
                  <AlertDialogDescription className="text-white border border-white p-4 rounded hover:bg-gray-600">
                    <strong>The Pomodoro Technique </strong>
                    {`
                     is a time management method that uses a timer to break work into intervals called Pomodoros. 
                     The Pomodoro timer is traditionally set for 25 minutes, but can be customized to fit your needs. 
                     The basic steps are:`}
                    <br />
                    <br />
                    <ol>
                    ...
                    <Button className="hover:bg-white hover:text-black">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer hover:bg-white "
                      >
                ...
                <AlertDialogFooter>
                  <AlertDialogCancel className=" text-slate-300 border border-white p-2 rounded hover:bg-white">Cancel</AlertDialogCancel>
                  <AlertDialogAction className=" text-slate-300 border border-white p-2 rounded hover:bg-white">Continue</AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            </AlertDialog>
          </div>
